...
import 'package:perplexity_clone_beta/pages/chat_page.dart';
...
import 'package:perplexity_clone_beta/widgets/search_bar_button.dart';
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(width: 12),
                    SearchBarButton(icon: Icons.add_circle, text: "Attached"),
                    Spacer(),
                    GestureDetector(
                      onTap: () {
